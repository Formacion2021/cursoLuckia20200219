...
public partial class _Default : Page
{
    ...
    protected void btnMostrarDatos_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        adp.Fill(ds);
        gvArriba.DataSource = ds;
        gvArriba.DataBind();        
    }

    protected void btnOcultarDatos_Click(object sender, EventArgs e)
    {
        gvArriba.DataSource = new DataTable();
        gvArriba.DataBind();
    }
    ...
    protected void BtnGuardar_Click(object sender, EventArgs e)
    {
        ...
        {
            c.Open();
            string query = "insert into AdventureWorks2017..EjercicioWebForms (Nombre,Apellido,Password) values ('" + tbNombre.Text + "','" + tbApellido.Text + "','" + tbPassword.Text + "')";
